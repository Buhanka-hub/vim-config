...
" Run Python and C files by Ctrl+h
 " autocmd FileType python map <buffer> <C-h> :w<CR>:exec '!python3.12' shellescape(@%, 1)<CR>
 " autocmd FileType python imap <buffer> <C-h> <esc>:w<CR>:exec '!python3.12' shellescape(@%, 1)<CR>
